...
[Click here to download the workshop materials](https://github.com/ck37/hands-on-precision-psychiatry-ai)

   * Click green "Code" button
   * Click "Download Zip"
   * Extract this zip file to your Dropbox / Box / etc. and open the folder in Positron (File -> Open Folder)
...
![Decision Tree](slides_img/dt.jpg){fig-align="center"}
...
::: {layout-ncol=2}
![Forest](slides_img/pexels-free-forest.png)

![Random Forest Medical](slides_img/med-rf.png)
:::
...
::: {layout-ncol=2}
![XGBoost CV Hyperparameters](slides_img/xgb-cvhyper.png)

![XGBoost Test AUC](slides_img/xgb-testAUC.png)
:::
...
::: {layout-ncol=2}
![SuperLearner CV Risk](slides_img/cvsl-risk.png)

![SuperLearner AUC](slides_img/cvsl-auc.png)
:::
